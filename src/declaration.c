...
void show_declaration(void)
{
    static const char *declaration =
        ...
        "• We did not share our codes with others or upload them to any other places for public access and will\n"
        ...
        "  upload them to any other places for public access.\n"
